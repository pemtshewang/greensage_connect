        ...
        loading ? (
          <VStack>
            <HStack>
              ...
              <Box flex="1" padding="2" borderWidth="1" justifyContent="center" borderColor="coolGray.500">
            ...
            <HStack>
              ...
              <Box flex="1" padding="2" flexDirection="row" borderWidth="1" borderColor="coolGray.500">
                <Text flex="1" italic fontSize="sm">
          ...
          <Box paddingY="5">
            <Text color="#A0A0A0">You haven't been allocated any MQTT Broker yet!</Text>
          </Box>
        )
      }
    </VStack>
